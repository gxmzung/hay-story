...
export default function MyPageClient() {
  return (
    <section className="mx-auto max-w-7xl px-6 py-16">
      <p className="text-sm tracking-[0.3em] text-neutral-400">MY PAGE</p>
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <p className="mt-3 text-sm opacity-70">저장한 스타일 보기</p>
        </Link>
        ...
        >
          ...
          <p className="mt-3 text-sm opacity-70">담아둔 상품 확인</p>
        </Link>
